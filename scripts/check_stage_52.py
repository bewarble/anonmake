...
def main():
    require('app/web/static/admin-stage52.js','valueMissing','typeMismatch','tooShort','aria-invalid','admin-field-error','focusFirstInvalid','scrollIntoView')
    ...
    print('Inline validation, first-invalid focus and mobile error styling: ready')
