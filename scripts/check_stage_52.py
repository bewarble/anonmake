...
def main():
    require('app/web/static/admin-stage52.js','valueMissing','typeMismatch','tooShort','aria-invalid','admin-field-error','revealFirstInvalid',"addEventListener('invalid'",'invalidTimer','scrollInvalidBlock','window.scrollTo')
    require('app/web/static/admin-stage52.css','has-error','aria-invalid="true"','admin-field-error')
    require('app/web/templates/base.html','admin-stage52.css?v=','admin-stage52.js?v=')
