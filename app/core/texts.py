...
NO_ACTIVE_ACCESS = (
    ...
    "Возможные причины:\n"
    "• Подписка оформлена в другом боте.\n"
    "• Подписка уже отменена.\n"
    "• Подписка оформлена с другого аккаунта."
)
AUTO_RENEW_ALREADY_OFF = "✅ Авто-продление успешно отключено!"
AUTO_RENEW_CONFIRM = "✅ Авто-продление успешно отключено!"
AUTO_RENEW_OFF = "✅ Авто-продление успешно отключено!"
...
REVEAL_CONSENT = (
    ...
    '<a href="https://sms.mooncloud.ltd/terms">условиями пользования</a>, '
    '<a href="https://sms.mooncloud.ltd/privacy">политикой конфиденциальности</a> и '
    '<a href="https://sms.mooncloud.ltd/pricing">тарифами</a>.'
)
