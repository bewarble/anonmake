...
.PHONY: docker-config docker-build docker-up docker-down docker-restart \
	...
	stabilize-apply stage50-check stage51-check stage52-check stage53-check stage54-check stage55-check stage56-check stage57-check stage58-check stage59-check stage60-check stage61-check release-check release-check-runtime deploy
